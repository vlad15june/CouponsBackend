...
public class CustomerGetPurchasedCategoryHandlerGet implements HttpHandler {
	...
	public void handleRequest(final HttpServerExchange exchange) throws Exception {
		...
		final List<Coupon> coupons = CustomerFacade.getCouponsByCategory(payload, category);
